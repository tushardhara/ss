			<div class="article clearfix " id="<?php echo $post->ID ?>">
				<div class="back clearfix"><a href="<?php echo site_url('word-around-town')?>"><span class="icon"></span><span>Back to World around town</span></a></div>
				...
				<div class="fb-comments" data-href="<?php echo get_permalink( $post->ID )?>" data-width="960" data-numposts="5" data-colorscheme="light" mobile="false"></div>
			</div>